...
while 1: #game loop###########################################################
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if mousePos[0]>238 and mousePos[0] < 355 and mousePos[1]>130 and mousePos[1]<230:
               chest = 2
            if mousePos[0]>638 and mousePos[0] <755 and mousePos[1]>130 and mousePos[1]<230:
               chest2 = 2
    ...
    if chest == 2 and event.type == pygame.MOUSEBUTTONUP or chest2 == 2 and event.type == pygame.MOUSEBUTTONUP:
        ticker+=1
        if ticker >= 200:
            ticker = 0
            chest = 1
    ...
    if chest2 == 1:
      screen.blit(chestImg1, (640, 140))
    elif chest2 == 2:
      screen.blit(chestImg2, (640, 140))
